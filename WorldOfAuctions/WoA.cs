...
namespace WorldOfAuctions
{
    public class WoA
    {
        ...
        private MongoUrl mongoUrl = new MongoUrlBuilder { DatabaseName = "WoA", Server = new MongoServerAddress("localhost"), Username = "admin", Password = "admin" }.ToMongoUrl();
        private BlizzardClient _blizzard;
        private AuctionViewer _auctionViewer;
